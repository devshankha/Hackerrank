...
public class MaximumNumOfChocolates {
  static int maxNumOfChocolates(int arr[], int n, int k) {
	...
	public static void main(String[] args) {
		// int arr[] = { 2, 7, 6, 1, 4, 5 };
		/**
		 * try with these samples {3,6,9} //trivial case {3,6,9,1} non trivial
		 * {3,6,9,1,6,96} most non-trivial case {3,6,1,4,92} another non trivial case
		 * {3,6,1,9,24} {3,6,1,21,6} {3,6,1,8,40}
		 */
